...
Hr.propTypes = {
    lineStyle: _propTypes2.default.oneOfType([_propTypes2.default.shape({}), _propTypes2.default.number]),
    text: _propTypes2.default.string,
    marginLeft: _propTypes2.default.number,
    marginRight: _propTypes2.default.number,
    textStyle: _propTypes2.default.oneOfType([_propTypes2.default.shape({}), _propTypes2.default.number])
};
